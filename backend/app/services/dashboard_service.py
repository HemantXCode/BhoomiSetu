    ...
    if user.role == 'DISTRICT_AUTHORITY':
        ...
        for v in verifications:
            ...
            queue.append({
                ...
                "task_id": v.task_id,
                "parcel_no": p.parcel_number if p else f"Gat No. {v.parcel_id}",
    ...
    if user.role == 'FIELD_OFFICER':
        ...
        for t in db_tasks:
            ...
            live_tasks_list.append({
                ...
                "village": f"{p.village} ({p.parcel_number})" if p else "Inspection Parcel",
        ...
        for v in db_visits:
            ...
            visits_list.append({
                ...
                "parcel_number": p.parcel_number if p else None,
